...
elSelect = document.querySelector(".select__films");
elListFilm = document.querySelector(".list__films");
...
elItem.setAttribute("class", "films__item bg-white mb-4 pb-2 shadow rounded")
elTitle.setAttribute("class", "fst-italic text-center" )
elText.setAttribute("class", " text-center text-primary" )
elImg.setAttribute("src", pokemon.img);
elImg.setAttribute("class", "rounded text-center");
elImg.setAttribute("width", "150");
elImg.setAttribute("height", "150");
elBtn.setAttribute("class", "btn btn-primary ms-1")
...
elText.textContent = `Capabilities: ${pokemon.type}`;

elListFilm.appendChild(elItem);
